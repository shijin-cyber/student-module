                ...
                <ul class="sidebar__nav ">
                    <li>
                        <a href="#" class="sidebar__nav__link">
                            ...
                            <span class="sidebar__nav__text">{{ Auth::user()->name }}</span>
                        </a>
                    </li>


                    <li>
                        <a href="{{url('notes')}}" class="sidebar__nav__link">
                            <i class="mdi mdi-fingerprint"></i>
                            <span class="sidebar__nav__text">Notes</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="sidebar__nav__link">
                            <i class="mdi mdi-credit-card"></i>
                            <span class="sidebar__nav__text"></span>
                        </a>
                    </li>
