...
<head>
    ...
    <!-- Main CSS-->
    <link href="addcss/main.css" rel="stylesheet" media="all">
</head>
...
<div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Student enrollment</h2>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="total_perfomance">
    ...
    <!-- Main JS-->
    <script src="addaddjs/global.js"></script>
</body>
</html>
@endsection